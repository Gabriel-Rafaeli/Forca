namespace Forca.FormsApp
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            // btnA
            // 
            btnA.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
            ...
            // panelLetras
            // 
            panelLetras.ColumnCount = 7;
            panelLetras.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 14.36782F));
            panelLetras.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 14.36782F));
            panelLetras.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 14.36782F));
            panelLetras.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 14.36782F));
            panelLetras.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 14.36782F));
            panelLetras.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 14.36782F));
            panelLetras.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 13.7931F));
            panelLetras.Controls.Add(btnA, 0, 0);
            panelLetras.Controls.Add(btnB, 1, 0);
            panelLetras.Controls.Add(btnC, 2, 0);
            panelLetras.Controls.Add(btnD, 3, 0);
            panelLetras.Controls.Add(btnZ, 4, 3);
            panelLetras.Controls.Add(btnE, 4, 0);
            panelLetras.Controls.Add(btnY, 3, 3);
            panelLetras.Controls.Add(btnF, 5, 0);
            panelLetras.Controls.Add(btnG, 6, 0);
            panelLetras.Controls.Add(btnH, 0, 1);
            panelLetras.Controls.Add(btnI, 1, 1);
            panelLetras.Controls.Add(btnJ, 2, 1);
            panelLetras.Controls.Add(btnK, 3, 1);
            panelLetras.Controls.Add(btnL, 4, 1);
            panelLetras.Controls.Add(btnM, 5, 1);
            panelLetras.Controls.Add(btnN, 6, 1);
            panelLetras.Controls.Add(btnO, 0, 2);
            panelLetras.Controls.Add(btnP, 1, 2);
            panelLetras.Controls.Add(btnQ, 2, 2);
            panelLetras.Controls.Add(btnR, 3, 2);
            panelLetras.Controls.Add(btnS, 4, 2);
            panelLetras.Controls.Add(btnT, 5, 2);
            panelLetras.Controls.Add(btnU, 6, 2);
            panelLetras.Controls.Add(btnV, 0, 3);
            ...
            // imgCabeca
            // 
            imgCabeca.Image = Properties.Resources.cabecaBoneco;
            imgCabeca.Location = new Point(198, 119);
            imgCabeca.Name = "imgCabeca";
            imgCabeca.Size = new Size(100, 90);
            imgCabeca.SizeMode = PictureBoxSizeMode.Zoom;
            imgCabeca.TabIndex = 33;
            imgCabeca.TabStop = false;
            imgCabeca.Visible = false;
            // 
            // imgCorpo
            // 
            imgCorpo.Image = Properties.Resources.corpoBoneco;
            imgCorpo.Location = new Point(236, 205);
            imgCorpo.Name = "imgCorpo";
            imgCorpo.Size = new Size(26, 102);
            imgCorpo.SizeMode = PictureBoxSizeMode.Zoom;
            imgCorpo.TabIndex = 34;
            imgCorpo.TabStop = false;
            imgCorpo.Visible = false;
            // 
            // imgBracoD
            // 
            imgBracoD.Image = Properties.Resources.bracoDireitoBoneco1;
            imgBracoD.Location = new Point(259, 206);
            imgBracoD.Name = "imgBracoD";
            imgBracoD.Size = new Size(57, 92);
            imgBracoD.SizeMode = PictureBoxSizeMode.Zoom;
            imgBracoD.TabIndex = 35;
            imgBracoD.TabStop = false;
            imgBracoD.Visible = false;
            // 
            // imgBracoE
            // 
            imgBracoE.Image = (Image)resources.GetObject("imgBracoE.Image");
            imgBracoE.Location = new Point(188, 205);
            imgBracoE.Name = "imgBracoE";
            imgBracoE.Size = new Size(57, 92);
            imgBracoE.SizeMode = PictureBoxSizeMode.Zoom;
            imgBracoE.TabIndex = 36;
            imgBracoE.TabStop = false;
            imgBracoE.Visible = false;
            // 
            // imgPernaD
            // 
            imgPernaD.Image = Properties.Resources.pernaDireitaBoneco;
            imgPernaD.Location = new Point(251, 295);
            imgPernaD.Name = "imgPernaD";
            imgPernaD.Size = new Size(78, 98);
            imgPernaD.SizeMode = PictureBoxSizeMode.Zoom;
            imgPernaD.TabIndex = 37;
            imgPernaD.TabStop = false;
            imgPernaD.Visible = false;
            // 
            // imgPernaE
            // 
            imgPernaE.Image = Properties.Resources.pernaEsquerdaBoneco;
            imgPernaE.Location = new Point(167, 295);
            imgPernaE.Name = "imgPernaE";
            imgPernaE.Size = new Size(78, 98);
            imgPernaE.SizeMode = PictureBoxSizeMode.Zoom;
            imgPernaE.TabIndex = 38;
